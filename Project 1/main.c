 ...
 *
 * Entry point
 *    Measures performance overhead of led_update(),
...
extern volatile unsigned char timer0_tick;
...
int main(void) {
    // This runs before any library init, so it cannot hang due to UART/timer issues
